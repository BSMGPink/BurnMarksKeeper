...
MAKE_HOOK_OFFSETLESS(SaberBurnMarkArea_OnEnable, void, Il2CppObject* self) {
	int value = 0;
...
extern "C" void load() {
    getLogger().debug("Installing BurnMarksKeeper!");
		
	INSTALL_HOOK_OFFSETLESS(SaberBurnMarkArea_OnEnable, il2cpp_utils::FindMethodUnsafe("", "SaberBurnMarkArea", "OnEnable", 0)); 
	
	getLogger().debug("Installed BurnMarksKeeper!");
